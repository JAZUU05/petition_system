...
Public Class cce_cfn
    ...
    Sub view()
        ...
        daa.Dispose()
    End Sub
    Private Sub Cce_cfn_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'conn = New MySqlConnection("server=localhost;user id=root;password=;database=db_petition")

        Dim mrpt As New cfn_cce
        view()
    ...
    Private Sub Cce_cfn_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
